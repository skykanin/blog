...
#+DESCRIPTION: A test post exploring Org mode rendering, code blocks, tables and images in Hugo.
...
#+CAPTION: captioned x link
{{< x user=bbatsov id=502826405479317504 >}}
* LaTeX
{{< katex "["display"]" >}}
c = \pm\sqrt{a^2 + b^2}
{{< /katex >}}
